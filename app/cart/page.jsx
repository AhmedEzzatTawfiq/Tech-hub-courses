							...
							{cart?.map((item) => (
								<li className="flex items-start gap-4">
									<img
										...
										alt=""
										className="object-cover w-12 h-12 lg:w-20 lg:h-20 md:w-20 md:h-20 rounded"
									/>

									<div className=''>
										<h3 className="text-sm text-gray-900 text-[15px] lg:text-[18px] md:text-[18px]">{item?.product?.attributes?.title}</h3>

										<dl className="mt-0.5 space-y-px text-[10px] lg:text-[15px] md:text-[15px] text-gray-600">
											<div>
