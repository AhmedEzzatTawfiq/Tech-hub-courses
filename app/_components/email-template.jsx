		...
		<Body style={main}>
			<Container style={container}>
				...
				<Text style={paragraph}>
					Thank you purchasing on Ezzat TechHub courses. Click on Below download button to download the all digital content
				</Text>
				...
				<Hr style={hr} />
				{/* <Text style={footer}>Subscribe to Ahmed Ezzat</Text> */}
			</Container>
		</Body>
	</Html>
);
