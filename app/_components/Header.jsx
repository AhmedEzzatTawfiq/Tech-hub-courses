    ...
    !isLoggedIn && (
      <header className="bg-white dark:bg-gray-900">
        <div className="flex items-center h-16 max-w-screen-xl gap-8 px-4 mx-auto shadow-md sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between flex-1 md:justify-between">
            <nav aria-label="Global" className="md:block">
              <ul className="flex items-center gap-6 text-sm">
                ...
                <li>
                  <Link
                    className="text-gray-500 hover:text-gray-500/75 dark:text-white dark:hover:text-white/75 transition ease-in-out delay-1000 duration-300 cursor-pointer"
                    href="/#courses"
                  >
                    Courses
                  </Link>
